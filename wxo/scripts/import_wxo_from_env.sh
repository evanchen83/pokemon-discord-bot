...
Usage:
  wxo/scripts/import_wxo_from_env.sh [all|tools|kb|agent] [options]
...
Examples:
  wxo/scripts/import_wxo_from_env.sh
  wxo/scripts/import_wxo_from_env.sh all --env dev
...
IMPORT_SCRIPT="$REPO_ROOT/wxo/scripts/import_wxo_resources.sh"
